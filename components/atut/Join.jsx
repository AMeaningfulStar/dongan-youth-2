      ...
      <div class="lg:flex items-center space-x-16">
        ...
        <div class="w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg">
          ...
          <p className="text-center text-sm text-gray-600 mt-2">
            이미 계정이 있으신가요?
            <a href="/auth/login" className="text-amber-800 hover:text-amber-600 hover:underline" title="Sign In">
              로그인 하러 가기
            </a>
          </p>
          <form className="my-8 text-sm" onSubmit={ handleSubmit }>
            ...
            <div className="flex flex-col my-4">
              ...
              <div className="relative flex items-center mt-2">
                <input
                  ...
                  className="flex-1 border-2 border-gray-100 rounded-lg px-4 py-3 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:shadow-lg bg-white text-black"
                />
                <button onClick={() => setIsShow(!isShow)} type="button" className="absolute right-2 bg-transparent flex items-center justify-center text-gray-700">
                  <PasswordShowBtn />
                </button>
            ...
            <div id="button" className="flex flex-col w-full my-5">
              <button
                type="submit"
                className="w-full py-4 bg-[#F8BD8D] rounded-lg text-white"
              >
